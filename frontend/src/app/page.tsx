    ...
    <div className="min-h-screen bg-[#090d12] text-slate-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-300">
      ...
      <section id="funcionalidades" className="py-16 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="bg-[#131b22] border border-slate-800/80 p-6 rounded-3xl space-y-3 shadow-lg hover:border-emerald-500/40 transition group">
              ...
              <h3 className="font-extrabold text-base text-white">Turnos Casuales & Fijos Semanales</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Reservas puntuales y turnos fijos que se repiten automáticamente cada semana sin duplicar horarios.
              </p>
            </div>
            ...
            <div className="bg-[#131b22] border border-slate-800/80 p-6 rounded-3xl space-y-3 shadow-lg hover:border-emerald-500/40 transition group">
              ...
              <h3 className="font-extrabold text-base text-white">Cobro de Señas con Mercado Pago</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Conectá tus propias credenciales y recibí las señas directamente en tu cuenta bancaria al instante.
              </p>
            </div>
            ...
            <div className="bg-[#131b22] border border-slate-800/80 p-6 rounded-3xl space-y-3 shadow-lg hover:border-emerald-500/40 transition group">
              ...
              <h3 className="font-extrabold text-base text-white">Atención & Bot WhatsApp con IA</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                El bot responde consultas, informa disponibilidad y envía el link directo para que el jugador reserve.
              </p>
            </div>
            ...
            <div className="bg-[#131b22] border border-slate-800/80 p-6 rounded-3xl space-y-3 shadow-lg hover:border-emerald-500/40 transition group">
              ...
              <h3 className="font-extrabold text-base text-white">Tarifas Diurnas & Nocturnas</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Ajuste automático de precios cuando cae el sol y se enciende la luz artificial en las canchas.
              </p>
            </div>
            ...
            <div className="bg-[#131b22] border border-slate-800/80 p-6 rounded-3xl space-y-3 shadow-lg hover:border-emerald-500/40 transition group">
              ...
              <h3 className="font-extrabold text-base text-white">Reglas de Horarios & Bloqueos</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Definí horas de apertura/cierre, bloqueá turnos por torneos o lluvia y evitá reservas de horas pasadas.
              </p>
            </div>
            ...
            <div className="bg-[#131b22] border border-slate-800/80 p-6 rounded-3xl space-y-3 shadow-lg hover:border-emerald-500/40 transition group">
              ...
              <h3 className="font-extrabold text-base text-white">Tu Web Oficial en la Bio</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Tus clientes no necesitan descargar ninguna app pesada; reservan directamente desde cualquier celular.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="como-funciona" className="py-16 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#131b22] border border-slate-800 p-6 rounded-3xl space-y-3 text-left">
            ...
            <div className="bg-[#131b22] border border-slate-800 p-6 rounded-3xl space-y-3 text-left">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Pegás el link en tu Instagram, WhatsApp y Google Maps. Tus clientes ingresan desde cualquier celular.
              </p>
            </div>
            ...
            <div className="bg-[#131b22] border border-slate-800 p-6 rounded-3xl space-y-3 text-left">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                La seña se acredita en tu Mercado Pago y el turno se bloquea automáticamente en tu grilla en vivo.
              </p>
            </div>
          </div>
        </div>
